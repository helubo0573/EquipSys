		...
		<div id="equip-info" class="info-div">
			...
			<table id="equipinfo-table" class="table table-bordered">
				...
				<tr>
					...
					<th>设备型号</th><td><label id="equipmodelnumber-label"></label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><label id="equipsuppliernumber-label"></label></td>
				</tr>
				<tr>
					<th>备注</th><td colspan="5"><label id="remarks-label"></label></td>
				</tr>
			</table>
		</div>
	</div>
