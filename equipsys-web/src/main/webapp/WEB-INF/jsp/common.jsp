...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/Commons.css?d=202010032">
...
<script type="text/javascript" src="../plugins/layDate-v5.0.9/laydate/laydate.js"></script>
