package com.stone.equipsys.core.common.service.impl;
...
import com.stone.equipsys.core.common.service.Crypto;
import com.stone.equipsys.core.common.util.Base32;
...
public abstract class AbstractCryptoImpl implements Crypto
{
	...
	public String dectypt(String s, Encoding en, String charset)
	{
		...
		try
		{
			byte[] bs = en == Encoding.Base32 ? Base32.decode(s) : Base64.decodeBase64(s.getBytes(Base64StringCharset));
			bs = this.dectypt(bs);
	...
	public String encrypt(String s, Encoding en, String charset)
	{
		...
		try
		{
			...
			bs = this.encrypt(bs);
			return en == Encoding.Base32 ? Base32.encode(bs) : new String(Base64.encodeBase64(bs), Base64StringCharset);
		} catch (UnsupportedEncodingException e)
		{
			logger.error(e.getMessage(), e);
		}
