...
public class SqlUtil
{
	...
	/**
	 * SqlUtil.buildInsertSqlMap("cl_user", new Object[][] { { "login_name", phone }, { "login_pwd", EncryptUtil.MD5Encode(pwd).toUpperCase() }, { "invitation_code", randomInvitationCode(6) }, { "regist_time", new Date() }, { "uuid", uuid }, { "level", 3 }, { "channel_id", channelId } })
	 * @param tableName
	 * @param list
	 * @return
	 */
